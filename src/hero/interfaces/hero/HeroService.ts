// Original file: src/hero/hero.proto
...
export interface HeroServiceClient extends grpc.Client {
...
export interface HeroServiceHandlers extends grpc.UntypedServiceImplementation {
  FindOne: grpc.handleUnaryCall<_hero_HeroById__Output, _hero_Hero>;
  
}

export interface HeroServiceDefinition extends grpc.ServiceDefinition {
